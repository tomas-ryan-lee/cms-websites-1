 ...
 */
final class Version20210716092426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navigation ADD position_id INT NOT NULL, ADD location_nav VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navigation DROP position_id, DROP location_nav');
    }
}
